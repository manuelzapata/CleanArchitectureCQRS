...
using CleanArchitectureCQRS.Infrastructure.Files;
using CleanArchitectureCQRS.Infrastructure.Identity;
using CleanArchitectureCQRS.Infrastructure.Persistence;
using CleanArchitectureCQRS.Infrastructure.Persistence.Interceptors;
    ...
    public static IServiceCollection AddInfrastructureServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        if (configuration.GetValue<bool>("UseInMemoryDatabase"))
        {
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseInMemoryDatabase("CleanArchitectureCQRSDb"));
        }
        else
        {
            services.AddDbContext<ApplicationDbContext>(options =>
